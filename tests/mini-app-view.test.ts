...
import { openMiniAppSchema, type MiniAppTarget, type MiniAppView } from '@shared/mini-apps'
...
import { placeMiniApp, startMiniAppReports, useViewStore } from '../src/renderer/src/state/view'
