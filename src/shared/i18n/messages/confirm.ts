...
export const confirm = defineMessages({
  ...
  unavailable: {
    'ja-JP': '確認の画面を表示できません。',
    'en-US': "Couldn't show the confirmation.",
    'fr-FR': "Impossible d'afficher la confirmation.",
    'de-DE': 'Die Bestätigung ließ sich nicht anzeigen.',
    'hi-IN': 'पुष्टि की विंडो नहीं दिखाई जा सकी।',
    'id-ID': 'Tidak bisa menampilkan konfirmasinya.',
    'it-IT': 'Impossibile mostrare la conferma.',
    'ko-KR': '확인 화면을 표시할 수 없습니다.',
